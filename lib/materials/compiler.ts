...
function resolveInputNode(node: MaterialNodeData, handle: MaterialPortKey) {
...
function resolveMathNode(context: ResolutionContext, node: MaterialNodeData, handle: MaterialPortKey) {
  if (handle !== MATERIAL_PORT_KEYS.out) {
    return undefined;
  }
...
function resolveCodeNode(context: ResolutionContext, node: MaterialNodeData) {
